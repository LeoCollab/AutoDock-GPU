...
define_executable() {
	...
	adgpu_cmd_sw="${adgpu_binary} -ffile ${input_protein} -lfile ${input_ligand} -nrun 50 -lsmet sw --heuristics 0 --autostop 0"
	adgpu_cmd_ad="${adgpu_binary} -ffile ${input_protein} -lfile ${input_ligand} -nrun 50 -lsmet ad --heuristics 0 --autostop 0"
